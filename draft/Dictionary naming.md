...
| Powder           | pdCIF   | pdCIF   | pdCIF                | CIF_pd         | cif_pd.dic               |                        |                   | **cif_pd**         |                    | **CifPow** (!)        | Dictionary currently CIF_POW; CIF_PD preferred?  |
...
|                  |         |         |                      |                | mmcif_std.dic (P)        |                        |                   |                    |                    |                       |                                                  |
|                  |         |         |                      |                | mmcif_pdbx.dic (P)       |                        |                   |                    |                    |                       |                                                  |
| Image            | imgCIF  | imgCIF  | imgCIF               | CIF_img        | cif_img.dic              | Cif_img.dic            | **CIF_IMG**       |                    | **CIF_IMG_HEAD**   | **Ddlm** (!)          |                                                  |
|                  |         |         |                      |                | mmcif_img.dic (P)        |                        |                   |                    |                    |                       |                                                  |
